// Testing Framework for marketplace

/* We are going to use mocha that allows us 
to write organized test cases and it runs on nodeJS*/

// To compare returned values with expected values
